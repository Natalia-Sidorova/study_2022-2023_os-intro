...
Запуск программы 1 (рис. @fig:002).
...
файл должен получать в виде аргумента командной строки название команды и в виде
результата выдавать справку об этой команде или сообщение об отсутствии справки,
если соответствующего файла нет в каталоге man1. (рис. @fig:003).

![Код ко второму заданию](image/fig:003.jpg){#fig:003 width=70%}

Запуск программы 2 (рис. @fig:004).
...
выдаёт псевдослучайные числа в диапазоне от 0 до 32767. (рис. @fig:005).

![Код к третьему заданию](image/fig:005.jpg){#fig:005 width=70%}

Запуск программы 3 (рис. @fig:004).
