...
Изменила код в файле client.c в соответствии с заданием (рис. @fig:003).

![Код](image/fig:003.jpg){#fig:003 width=70%}

Открыла параллельно два окна терминала и запустила файлы server.c и client.c, они сработали верно (рис. @fig:004).
