...
Создала файл file.txt, записала в файл file.txt названия файлов, содержащихся в каталоге /etc и названия файлов, содержащихся в домашнем каталоге (рис. @fig:001).

![Запись в файл названия других файлов](image/fig:001.jpg){#fig:001 width=70%}

Вывела имена всех файлов из file.txt, имеющих расширение .conf, записала их в новый текстовой файл conf.txt (рис. @fig:002).

![имена файлов, имеющих данное расширение](image/fig:002.jpg){#fig:002 width=70%}

Определила, какие файлы в домашнем каталоге имеют имена, начинающиеся с символа c, сделала это двумя способами (рис. @fig:003).

![имена файлов, начинающиеся с символа с](image/fig:003.jpg){#fig:003 width=70%}

Вывела на экран (постранично) имена файлов из каталога /etc, начинающиеся с символа h (рис. @fig:004).

![имена файлов, начинающиеся с символа h](image/fig:004.jpg){#fig:004 width=70%}

Запустила в фоновом режиме процесс, который будет записывать в файл ~/logfile файлы, имена которых начинаются с log (рис. @fig:005).

![процесс записывания файлов, имена которых начинаются с log ](image/fig:005.jpg){#fig:005 width=70%}

Удалила файл ~/logfile (рис. @fig:006).

![удаление файла ](image/fig:006.jpg){#fig:006 width=70%}
...
прочла справку (man) команды kill, после чего использовала её для завершения процесса gedit (рис. @fig:007).

![ действия над редактором gedit ](image/fig:007.jpg){#fig:007 width=70%}

Выполнила команды df и du, предварительно получив более подробную информацию об этих командах, с помощью команды man (рис. @fig:008).

![ команды df и du ](image/fig:008.jpg){#fig:008 width=70%}

Воспользовавшись справкой команды find, вывела имена всех директорий, имеющихся в домашнем каталоге (рис. @fig:009).

![ имена всех директорий, имеющихся в домашнем каталоге ](image/fig:009.jpg){#fig:009 width=70%}
