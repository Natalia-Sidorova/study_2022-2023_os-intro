...
Использовала код с положительным, отрицательным числом и с нулем (рис. @fig:003).
...
последовательно от 1 до 𝑁 (например 1.tmp, 2.tmp, 3.tmp,4.tmp и т.д.). Число файлов,
которые необходимо создать, передаётся в аргументы командной строки. Этот же командный файл должен уметь удалять все созданные им файлы (если они существуют). (рис. @fig:004).

![Код задания 3](image/fig:004.jpg){#fig:004 width=70%}

Проверила работу кода (рис. @fig:005).
...
Распаковала полученный архив (рис. @fig:007).
