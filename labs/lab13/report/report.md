...
Код в файле calculate.c (рис. @fig:001)
...
Код в файле calculate.h (рис. @fig:003)

![Код вызова функции](image/fig:003.jpg){#fig:003 width=70%}

Код в файле main.c. (рис. @fig:004)

![Код интерфейса функции](image/fig:004.jpg){#fig:004 width=70%}

Выполнила компиляцию программы посредством gcc. Создала Makefile (рис. @fig:005)

![Код](image/fig:005.jpg){#fig:005 width=70%}

Запустила отладчик GDB. Запустила программу внутри него и попробовала ввести пример, вышел нужный результат. Просмотрела строки файлов. Установила точку установки, проверила что она работает и удалила ее. С помощью утилиты splint проанализировала коды файлов calculate.c и main.c (рис. @fig:006)
